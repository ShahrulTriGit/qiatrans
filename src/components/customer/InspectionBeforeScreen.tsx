...
export default function InspectionBeforeScreen() {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      if (data.success && data.data?.url) {
        ...
        // Use the local data URL as fallback
  ...
  const handleDetection = async () => {
    ...
    try {
      ...
      // Step 2: Run detection (simulated YOLOv8)
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="sticky top-0 z-10 bg-primary text-primary-foreground px-4 py-3 flex items-center gap-3 shadow-md">
        ...
        <h1 className="text-lg font-semibold">Inspeksi Sebelum Rental</h1>
      </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">Inspeksi Sebelum Rental</p>
              </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-start gap-2">
              ...
              <div className="text-sm text-muted-foreground">
                ...
                <p>Ambil foto kendaraan dari beberapa sudut untuk mendeteksi lecet atau kerusakan yang sudah ada sebelum rental dimulai. Sistem akan menganalisis gambar menggunakan AI.</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        {currentStep === 'upload' && (
          <Card>
            <CardHeader className="pb-2">
              ...
              <CardDescription>Foto akan dianalisis untuk mendeteksi lecet</CardDescription>
            </CardHeader>
        ...
        {currentStep === 'detect' && (
          <Card>
            <CardHeader className="pb-2">
              ...
              <CardDescription>AI akan menganalisis gambar untuk mendeteksi lecet</CardDescription>
            </CardHeader>
